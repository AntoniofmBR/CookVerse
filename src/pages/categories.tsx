...
export function Categories () {
  ...
  return (
    <main className='min-h-screen bg-blues-blue_500 flex flex-col items-center' >
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 sm:mb-12 mt-20 items-center justify-center w-3/4 gap-7' >
        <motion.button
        ...
        >
          <h1 className='lg:text-3xl md:text-2xl sm:text-xl font-bold text-whites-white_200' >
            Café <br/> da manhã
          </h1>
        ...
        >
          <h1 className='lg:text-3xl md:text-2xl sm:text-base font-bold text-whites-white_200' >
            Sobremesas
          </h1>
